fn main() {
    ...
    println!("\nThe {} is informed by the aspiration to 
     train electrical/electronic engineering proffessionals 
    ...
    println!("{} is aimed at developing competent, creative
     innovative, entrepreneurial and ethicall-minded persons,
     capable of creating value in the divese fields of 
     Computer Science", w3);
}
